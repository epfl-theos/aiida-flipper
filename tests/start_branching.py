...
def start_run():
    ...
    moldyn_parameters_thermalize = ParameterData(
        dict={
            'nstep': 10,
            'max_steps_percalc': 50,
            'resources': {
                'num_machines': 1
            },
    ...
    moldyn_parameters_nvt = ParameterData(
        dict={
            'nstep': 100,
            'max_steps_percalc': 60,
            'resources': {
                'num_machines': 1
            },
            'max_wallclock_seconds': 3600
    ...
    moldyn_parameters_nve = ParameterData(
        dict={
            'nstep': 20,
            'max_steps_percalc': 50,
            'resources': {
