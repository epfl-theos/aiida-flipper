...
def start_run():
    mc = ReplayCalculation(
        code=Code.get_from_string('pw-5.3.0'),
        structure=structure,
        parameters=parameters,
        moldyn_parameters=ParameterData(
            dict={
                'nstep': 10,
                'max_steps_percalc': 7,
                'resources': {
